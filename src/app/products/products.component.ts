...
},
{
  ...
  "price": 29.95,
  "description": "100% POLYURETHANE (shell) 100% POLYESTER (lining) Faux Leather. Removable hooded faux leather moto biker jacket. Regular fit.",
  "category": "women's clothing",
...
},
{
  ...
  "price": 39.99,
  "description": "Lightweight perfect for trip or casual wear—Long sleeve with attached hooded, adjustable drawstring waist design. Two front flap pockets. Keep you dry and stylish.",
  "category": "women's clothing",
...
},
{
  ...
  "price": 9.85,
  "description": "95% RAYON 5% SPANDEX. Lightweight fabric with great stretch for comfort. Ribbed on sleeves and neckline and bottom hem. Various colors available.",
  "category": "women's clothing",
...
topJewelry: ProductInterface[] = this.products.filter(
